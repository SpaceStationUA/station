...
namespace Content.Server.Guardian
{
    ...
    public sealed class GuardianSystem : EntitySystem
    {
        ...
        private void UseCreator(EntityUid user, EntityUid target, EntityUid injector, GuardianCreatorComponent component)
        {
            ...
            _doAfterSystem.TryStartDoAfter(new DoAfterArgs(EntityManager, user, component.InjectionDelay, new GuardianCreatorDoAfterEvent(), injector, target: target, used: injector){BreakOnTargetMove = true});
        }
