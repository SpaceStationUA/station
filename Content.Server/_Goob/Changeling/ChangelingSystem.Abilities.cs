...
using AbsorbableComponent = Content.Shared._Goob.Changeling.AbsorbableComponent;
using AbsorbBiomatterDoAfterEvent = Content.Shared._Goob.Changeling.AbsorbBiomatterDoAfterEvent;
using AbsorbBiomatterEvent = Content.Shared._Goob.Changeling.AbsorbBiomatterEvent;
using AbsorbDNADoAfterEvent = Content.Shared._Goob.Changeling.AbsorbDNADoAfterEvent;
using AbsorbDNAEvent = Content.Shared._Goob.Changeling.AbsorbDNAEvent;
using AbsorbedComponent = Content.Shared._Goob.Changeling.AbsorbedComponent;
using ActionAnatomicPanaceaEvent = Content.Shared._Goob.Changeling.ActionAnatomicPanaceaEvent;
using ActionBiodegradeEvent = Content.Shared._Goob.Changeling.ActionBiodegradeEvent;
using ActionChameleonSkinEvent = Content.Shared._Goob.Changeling.ActionChameleonSkinEvent;
using ActionEphedrineOverdoseEvent = Content.Shared._Goob.Changeling.ActionEphedrineOverdoseEvent;
using ActionFleshmendEvent = Content.Shared._Goob.Changeling.ActionFleshmendEvent;
using ActionHivemindAccessEvent = Content.Shared._Goob.Changeling.ActionHivemindAccessEvent;
using ActionLastResortEvent = Content.Shared._Goob.Changeling.ActionLastResortEvent;
using ActionLesserFormEvent = Content.Shared._Goob.Changeling.ActionLesserFormEvent;
using ActionSpacesuitEvent = Content.Shared._Goob.Changeling.ActionSpacesuitEvent;
using ChangelingActionComponent = Content.Shared._Goob.Changeling.ChangelingActionComponent;
using ChangelingComponent = Content.Shared._Goob.Changeling.ChangelingComponent;
using ChangelingEggComponent = Content.Shared._Goob.Changeling.ChangelingEggComponent;
using ChangelingReagentStingComponent = Content.Shared._Goob.Changeling.ChangelingReagentStingComponent;
using ChangelingTransformCycleEvent = Content.Shared._Goob.Changeling.ChangelingTransformCycleEvent;
using ChangelingTransformEvent = Content.Shared._Goob.Changeling.ChangelingTransformEvent;
using CreateBoneShardEvent = Content.Shared._Goob.Changeling.CreateBoneShardEvent;
using EnterStasisEvent = Content.Shared._Goob.Changeling.EnterStasisEvent;
using ExitStasisEvent = Content.Shared._Goob.Changeling.ExitStasisEvent;
using HivemindComponent = Content.Shared._Goob.Changeling.HivemindComponent;
using OpenEvolutionMenuEvent = Content.Shared._Goob.Changeling.OpenEvolutionMenuEvent;
using ShriekDissonantEvent = Content.Shared._Goob.Changeling.ShriekDissonantEvent;
using ShriekResonantEvent = Content.Shared._Goob.Changeling.ShriekResonantEvent;
using StingExtractDNAEvent = Content.Shared._Goob.Changeling.StingExtractDNAEvent;
using StingFakeArmbladeEvent = Content.Shared._Goob.Changeling.StingFakeArmbladeEvent;
using StingLayEggsEvent = Content.Shared._Goob.Changeling.StingLayEggsEvent;
using StingReagentEvent = Content.Shared._Goob.Changeling.StingReagentEvent;
using StingTransformEvent = Content.Shared._Goob.Changeling.StingTransformEvent;
using ToggleArmbladeEvent = Content.Shared._Goob.Changeling.ToggleArmbladeEvent;
using ToggleArmClawEvent = Content.Shared._Goob.Changeling.ToggleArmClawEvent;
using ToggleArmHammerEvent = Content.Shared._Goob.Changeling.ToggleArmHammerEvent;
using ToggleChitinousArmorEvent = Content.Shared._Goob.Changeling.ToggleChitinousArmorEvent;
using ToggleDartGunEvent = Content.Shared._Goob.Changeling.ToggleDartGunEvent;
using ToggleOrganicShieldEvent = Content.Shared._Goob.Changeling.ToggleOrganicShieldEvent;
using ToggleStrainedMusclesEvent = Content.Shared._Goob.Changeling.ToggleStrainedMusclesEvent;
