...
using AugmentedEyesightPurchasedEvent = Content.Shared._Goob.Changeling.AugmentedEyesightPurchasedEvent;
...
using ChangelingDartComponent = Content.Shared._Goob.Changeling.ChangelingDartComponent;
using ChangelingReagentStingComponent = Content.Shared._Goob.Changeling.ChangelingReagentStingComponent;
using TransformData = Content.Shared._Goob.Changeling.TransformData;
