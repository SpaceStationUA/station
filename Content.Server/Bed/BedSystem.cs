...
using Content.Shared.SimpleStation14.Silicon.Components; // Pirate Parkstation-IPCs // I shouldn't have to modify this.
        ...
        public override void Update(float frameTime)
        {
            ...
            while (query.MoveNext(out var uid, out _, out var bedComponent, out var strapComponent))
            {
                ...
                foreach (var healedEntity in strapComponent.BuckledEntities)
                {
                    ...
                    || HasComp<SiliconComponent>(healedEntity)) // Pirate // Parkstation-IPCs // I shouldn't have to modify this.
                        continue;
