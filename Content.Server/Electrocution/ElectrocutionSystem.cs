...
public sealed class ElectrocutionSystem : SharedElectrocutionSystem
{
    ...
    public const float ElectrifiedDamagePerWatt = 0.0015f; //Pirate Parkstation-IPC // This information is allowed to be public, and was needed in BatteryElectrocuteChargeSystem.cs
        ...
        StatusEffectsComponent? statusEffects = null, bool ignoreInsulation = false)
    {
        ...
        RaiseLocalEvent(uid, new ElectrocutedEvent(uid, sourceUid, siemensCoefficient, shockDamage), true); //Pirate Parkstation-IPC
        return true;
    }
