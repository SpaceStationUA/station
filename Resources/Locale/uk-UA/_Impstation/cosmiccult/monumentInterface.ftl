...
monument-interface-entropy-crew-convert-title = Конвертованих до наступного Етапу:

# Glyphs
monument-interface-glyphs-title = Гліфи
monument-interface-glyphs-button-scribe = Накреслити гліф
monument-interface-glyphs-button-unscribe = Зняти гліф
