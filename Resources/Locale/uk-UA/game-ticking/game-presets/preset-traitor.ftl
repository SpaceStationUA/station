...
traitor-role-uplink-implant = Ваш імплантат аплінк активовано, перейдіть до нього з гарячої панелі. Аплінк захищено, якщо ніхто не вилучить його з вашого тіла. # не потрібен весь текст смаку для символьного меню
