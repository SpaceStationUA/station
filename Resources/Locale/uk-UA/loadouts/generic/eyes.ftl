...
loadout-name-LoadoutEyesGlassesSunglassesAviator = авіатори (кольорові)
loadout-name-LoadoutEyesBlindfoldFakeColor = "сліпа" складка (кольорова)
loadout-description-LoadoutEyesBlindfoldFakeColor = Цей продукт може працювати не так, як заявлено.