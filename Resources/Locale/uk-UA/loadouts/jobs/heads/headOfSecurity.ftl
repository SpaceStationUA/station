...
loadout-description-LoadoutCommandHOSOuterWinter = Тепле пальто для космічного холоду.
loadout-description-LoadoutCommandHOSOuterTrench = Тренчкот для HOS.
loadout-description-LoadoutCommandHOSHatBeret = Берет для HOS.
loadout-description-LoadoutCommandHOSHatHoshat = Капелюх HOS, дуже гарний.
