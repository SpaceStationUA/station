...
news-read-ui-prev-tooltip = Попередній
...
news-write-ui-article-count-0 = 0 Статті
news-write-ui-article-count-text = {$count} Статті
news-write-ui-footer-text = Новини#Авторська система Manager™
