...
surgery-popup-step-SurgeryStepClampBleeders = {$user} накладає затискачі на судини на {$part} у {$target}.
...
surgery-popup-step-SurgeryStepInsertFeature = {$user} вставляє щось у {$part} у {$target}!
...
surgery-popup-step-SurgeryStepClampInternalBleeders = {$user} накладає затискачі на внутрішні судини на {$part} у {$target}.
