...
# Greeting
blob-role-greeting =
    Ви — блоб — паразитична космічна істота, здатна знищувати цілі станції.
...
blob-description = Блоб-інфекція — це паразитична космічна істота, здатна знищувати цілі станції. Вона майже невразлива до фізичних ушкоджень, але тепло може завдати їй шкоди. Мета Блоб-інфекції — вижити й вирости якомога більшою. Використовуйте Alt+E, щоб оновлювати звичайні тайли блоба до сильних, а сильні — до відбивних. Обов’язково розміщуйте ресурсні блоби, щоб генерувати ресурси. Пам’ятайте, що ресурсні блоби та фабрики працюють лише тоді, коли поруч є вузлові блоби або ядро.
