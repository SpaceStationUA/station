...
heretic-role-greeting-fluff = Ще один день на безглуздій роботі. Ви відчуваєте мерехтіння навколо себе, як розгортається усвідомлення чогось дивного в повітрі. Ти дивишся всередину себе і відкриваєш щось, що змінить твоє життя. Ворота Мансуса відкриваються перед твоїм розумом.

heretic-role-greeting = Ви - Єретик! Детальніше про вашу роль читайте у статті путівника.

heretic-role-greeting-short = Ти - Єретик! Щоб навчитися Останнього Ритуалу і Піднятися, ти повинен виконати свої завдання. упир
heretic-ghoul-greeting = Тебе покликав у цей світ {CAPITALIZE(THE($ent))}! Ти повинен допомогти йому в його подорожі до вознесіння і захистити його за будь-яку ціну. Ти можеш слідувати за іншими єретиками, якщо твій вчитель не воскресне.
heretic-ghoul-greeting-noname = Ви були покликані в цей світ силами елдритів. Підкоряйтеся наказам своїх господарів, незважаючи ні на що.
