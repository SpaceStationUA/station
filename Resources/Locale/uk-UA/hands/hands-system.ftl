## HandsSystem
hands-system-missing-equipment-slot = У тебе немає {$slotName}, щоб щось витягнути!
hands-system-empty-equipment-slot = У твоєму {$slotName} нічого немає, щоб витягнути!
