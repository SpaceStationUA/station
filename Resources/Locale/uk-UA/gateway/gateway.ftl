...
gateway-window-portal-unlock = Наступне розблокування
gateway-window-locked = Закрито

gateway-access-denied = Доступ заборонено!
gateway-close-portal = Закрити портал
