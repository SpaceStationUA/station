...
ent-ClockworkWindowDiagonal = "name"
   .desc = "desc"
ent-ShuttleWindow = shuttle window
   .desc = "desc"
ent-ShuttleWindowDiagonal = "name"
   .desc = "desc"
...
ent-UraniumWindowDiagonal = "name"
   .desc = "desc"
...
ent-UraniumReinforcedWindowDirectional = directional reinforced uranium window
   .desc = Don't smudge up the glass down there.
ent-ReinforcedUraniumWindowDiagonal = "name"
   .desc = "desc"
ent-ThrusterUnanchored = "name"
   .desc = "desc"
ent-GyroscopeUnanchored = "name"
   .desc = "desc"
