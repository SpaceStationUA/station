ent-DefibrillatorOneHandedUnpowered = "name"
   .desc = "desc"
ent-BaseToolSurgery = "name"
   .desc = "desc"
ent-Cautery = cautery
...
ent-SyndiCrewMonitorEmpty = "name"
   .desc = "desc"
