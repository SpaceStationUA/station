...
{
    private static readonly Regex RestrictedNameRegex = new(@"[^\u0030-\u0039,\u0041-\u005A,\u0061-\u007A,\u00C0-\u00D6,\u00D8-\u00F6,\u00F8-\u00FF,\u0100-\u017F,\u0400-\u052F\u2DE0-\u2DFF\uA640-\uA69F' -]");
    ...
    public HumanoidCharacterProfile WithVoice(string voice) => new(this) { Voice = voice}; //Pirate
    ...
    public void EnsureValid(ICommonSession session, IDependencyCollection collection)
    {
        ...
        // var voice = "";
 		// prototypeManager.TryIndex<TTSVoicePrototype>(Voice, out voice); //Pirate
        //     if (voice is null || !CanHaveVoice(voice, Sex)) //Pirate
        //         Voice = SharedHumanoidAppearanceSystem.DefaultSexVoice[sex]; //Pirate

        if (!prototypeManager.TryIndex<TTSVoicePrototype>(Voice, out var voice) || !CanHaveVoice(voice, sex))
        {
            Voice = SharedHumanoidAppearanceSystem.DefaultSexVoice[sex]; //Pirate
        }
