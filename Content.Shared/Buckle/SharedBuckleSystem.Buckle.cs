...
public abstract partial class SharedBuckleSystem
{
    ...
    private void OnBuckleUpdateCanMove(EntityUid uid, BuckleComponent component, UpdateCanMoveEvent args)
    {
        ...
        if (component.Buckled && // buckle shitcode
            !HasComp<VehicleComponent>(component.BuckledTo)) //Pirate hoverbikes
            args.Cancel();
    }
    ...
    public bool TryUnbuckle(EntityUid buckleUid, EntityUid userUid, bool force = false, BuckleComponent? buckleComp = null)
    {
        ...
        if (!force)
        {
            ...
            if (TryComp<VehicleComponent>(strapUid, out var vehicle) && vehicle.Rider != userUid && !_mobState.IsIncapacitated(buckleUid)) //Pirate hoverbikes
                return false;
