...
public sealed partial class WizardMirrorWindow : DefaultWindow
{
    ...
    public void RefreshSpecies()
    {
        ...
        if (AllowedSpecies != null)
        {
            ...
            if (Profile != null && _prototypeManager.TryIndex<SpeciesPrototype>(Profile.Species, out var prototype) && !_species.Contains(prototype))
    ...
    private void ReloadPreview()
    {
        ...
        PreviewDummy = _controller.LoadProfileEntity(Profile, false, false);
