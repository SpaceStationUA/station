...
namespace Content.Client.Preferences.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
        ...
        private OptionButton _voiceButton => CVoiceButton; // Pirate TTS
        private Button _voicePlayButton => CVoicePlayButton; // Pirate TTS
        ...
        private void SetSex(Sex newSex)
        {
            ...
            UpdateTTSVoicesControls(); // Pirate TTS
            CMarkings.SetSex(newSex);
            IsDirty = true;
            UpdatePreview();
        }

        private void SetVoice(string newVoice) // Pirate
        {
