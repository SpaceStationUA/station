...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class AudioTab : Control
    {
        ...
        public AudioTab()
        {
            ...
            TtsVolumeSlider.OnValueChanged += OnTtsVolumeSliderChanged; // TTS
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(SimpleStationCCVars.TTSVolume, TtsVolumeSlider.Value / 100f * ContentAudioSystem.TtsMultiplier); // TTS
        ...
        private void Reset()
        {
            ...
            TtsVolumeSlider.Value = _cfg.GetCVar(SimpleStationCCVars.TTSVolume) * 100f / ContentAudioSystem.TtsMultiplier; // TTS
        ...
        private void UpdateChanges()
        {
            ...
            var isTtsVolumeSame =
                Math.Abs(TtsVolumeSlider.Value - _cfg.GetCVar(SimpleStationCCVars.TTSVolume) * 100f / ContentAudioSystem.TtsMultiplier) < 0.01f;
            ...
            isEverythingSame = isEverythingSame && isTtsVolumeSame; // TTS
            ...
            TtsVolumeLabel.Text =
                Loc.GetString("ui-options-volume-percent", ("volume", TtsVolumeSlider.Value / 100)); // TTS
